    ...
    <form className='flex flex-col items-start w-full gap-3'>
      ...
      <div className='flex flex-col gap-2 sm:flex-row w-full sm:gap-8'>
        ...
        <div>
            ...
            <input className='w-full px-3 py-2 sm:w-[120px]' type="number" placeholder='20' />
        </div>
        ...
        <div className='flex gap-2 mt-2'>
            <input type="checkbox" id='besrseller' />
            <label label='cursor-pointer' htmlFor="bestseller">Add to bestseller</label>
        </div>
        <button className='w-28 py-3 mt-4 bg-green-600 text-white' type="submit">ADD</button>
